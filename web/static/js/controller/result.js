 ...
 */
whaleModule.controller("ResultController",["$scope","$rootScope","$window","$http","$interval","$location","DateCenter","$timeout" ,function($scope,$rootScope,$window,$http,$interval,$location,DateCenter,$timeout){
