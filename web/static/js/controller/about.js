/**
 * Created by peter.dong on 16/12/6.
 */
pictureModule.controller("AboutController",["$scope","$window","$http","$interval","$location",  function($scope,$window,$http,$interval,$location){
