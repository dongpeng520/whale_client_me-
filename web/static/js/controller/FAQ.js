/**
 * Created by peter.dong on 16/12/14.
 */
pictureModule.controller("FAQController",["$scope","$location","$http", "$window","$location",  function($scope,$location,$http, $window,$location) {
